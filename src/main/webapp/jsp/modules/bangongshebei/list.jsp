...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">办公设备管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">办公设备管理</li>
								<li class="breadcrumb-item active">办公设备列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">办公设备列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "设备申请"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"shebeishenqing\")");
			if(crossBtnControl('设备申请') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("bangongshebei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("bangongshebei"+colName,"GET",{
		...
		function detail(id){
			...
			window.location.href = "info.jsp";
					...
					//填充下拉框选项
					http("option/shebeifenlei/fenlei","GET",{},(res)=>{
						if(res.code == 0){
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"bangongshebei");
