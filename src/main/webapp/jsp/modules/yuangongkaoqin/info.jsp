								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					<div class="form-group col-md-6">
																								...
																								<input id="kaoqinbianhao" name="kaoqinbianhao" class="form-control" v-model="ruleForm.kaoqinbianhao" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>考勤名称</label>
												
																								<input id="kaoqinmingcheng" name="kaoqinmingcheng" class="form-control" v-model="ruleForm.kaoqinmingcheng" readonly>
																							</div>
