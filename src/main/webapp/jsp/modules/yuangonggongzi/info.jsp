								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					<div class="form-group col-md-6">
																								...
																								<input id="gongzidanhao" name="gongzidanhao" class="form-control" v-model="ruleForm.gongzidanhao" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="jiangli" name="jiangli" class="form-control" v-model="ruleForm.jiangli" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="gonglinggongzi" name="gonglinggongzi" class="form-control" v-model="ruleForm.gonglinggongzi" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>五险一金</label>
												
																								<input id="wuxianyijin" name="wuxianyijin" class="form-control" v-model="ruleForm.wuxianyijin" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>考勤扣款</label>
												
																								<input id="kaoqinkoukuan" name="kaoqinkoukuan" class="form-control" v-model="ruleForm.kaoqinkoukuan" readonly>
																							</div>
