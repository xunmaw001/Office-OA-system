...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					<div class="form-group col-md-6">
																								...
																								<input id="shebeibianhao" name="shebeibianhao" class="form-control" v-model="ruleForm.shebeibianhao" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>申请标题</label>
												
																								<input id="shenqingbiaoti" name="shenqingbiaoti" class="form-control" v-model="ruleForm.shenqingbiaoti" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="shenqingshuliang" name="shenqingshuliang" class="form-control" v-model="ruleForm.shenqingshuliang" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="guihairiqi" name="guihairiqi" class="form-control" v-model="ruleForm.guihairiqi" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								<label>申请附件</label>
																									...
																									<button id="shenqingfujian">点击下载</button>
																							</div>
	...
	<script>
		...
		function setDownloadBtn(){
																																																																											var shenqingfujianUrl = "download('" + ruleForm.shenqingfujian + "')";
					$("#shenqingfujian").attr("onclick",shenqingfujianUrl);
																																																			}			
		//设置音视频播放链接
